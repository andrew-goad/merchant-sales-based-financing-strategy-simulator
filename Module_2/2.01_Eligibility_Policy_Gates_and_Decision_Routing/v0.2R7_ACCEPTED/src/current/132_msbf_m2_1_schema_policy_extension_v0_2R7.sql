...
Program : 132_msbf_m2_1_schema_policy_extension_v0_2R7.sql
Version : v0.2R7
...
SELECT
    s.run_id,s.strategy_campaign_code,s.strategy_campaign_version,
    s.strategy_campaign_name,s.strategy_type,s.policy_code,
    s.baseline_flag,s.campaign_status,s.effective_start_date,
    s.effective_end_date,s.description,s.source_g2_combined_hash,
    s.policy_configuration_hash,
    msbf_ctl.m2_1_hash_jsonb(
        jsonb_build_object(
            'module1_run_id', s.run_id,
            'strategy_campaign_code', s.strategy_campaign_code,
            'strategy_campaign_version', s.strategy_campaign_version,
            'strategy_campaign_name', s.strategy_campaign_name,
            'strategy_type', s.strategy_type,
            'policy_code', s.policy_code,
            'baseline_flag', s.baseline_flag,
            'campaign_status', s.campaign_status,
            'effective_start_date', s.effective_start_date,
            'effective_end_date', s.effective_end_date,
            'description', s.description,
            'source_g2_combined_hash', s.source_g2_combined_hash,
            'policy_configuration_hash', s.policy_configuration_hash
        )
    )
FROM seed AS s
...
WITH run_context AS (
    ...
    VALUES
        ...
        ('GATE_05_PROCESSOR_CONTINUITY', 5, 'Processor Continuity', 'OPERATIONS', 'REVIEW', 'processor_continuity_status', 'STABLE or MONITORED', 'WATCH, DISRUPTED, or UNAVAILABLE', 'Not applicable', 'Missing', FALSE, TRUE),
...
SELECT
    t.module1_run_id,t.strategy_campaign_code,t.gate_code,
    t.gate_sequence,t.gate_name,t.gate_category,
    t.decision_influence_code,t.source_field_code,t.pass_rule,
    t.review_rule,t.fail_rule,t.blocked_rule,
    t.hard_stop_capable_flag,t.active_flag,
    msbf_ctl.m2_1_hash_jsonb(to_jsonb(t))
FROM typed AS t
...
SELECT
    t.module1_run_id,t.strategy_campaign_code,t.reason_code,
    t.reason_category,t.reason_priority,t.source_gate_code,
    t.associated_route_code,t.display_text,
    t.production_adverse_action_flag,t.active_flag,
    msbf_ctl.m2_1_hash_jsonb(to_jsonb(t))
FROM typed AS t
...
SELECT
    t.module1_run_id,t.strategy_campaign_code,t.route_code,
    t.route_rank,t.route_name,t.eligible_for_offer_design_flag,
    t.terminal_flag,t.description,t.active_flag,
    msbf_ctl.m2_1_hash_jsonb(to_jsonb(t))
FROM typed AS t
