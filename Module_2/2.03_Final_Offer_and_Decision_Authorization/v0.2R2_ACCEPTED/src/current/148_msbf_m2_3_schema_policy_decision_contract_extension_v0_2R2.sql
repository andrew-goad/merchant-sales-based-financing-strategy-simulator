...
- Aligns the prohibited-payload assertion with the exact M2.3 stage-boundary
  vocabulary by adding `external_notice_payload` and `account_number`.
- Resolves M2_3_NEG_019_EXTERNAL_NOTICE_PAYLOAD without changing policy,
  outcome mapping, reason definitions, generated rows, hashes, lifecycle,
  accepted predecessor records, or business methodology.
============================================================================ */

/* ============================================================================
Prior v0.2R1 correction retained in v0.2R2
...
Program     : 148_msbf_m2_3_schema_policy_decision_contract_extension_v0_2R2.sql
Version     : v0.2R2
