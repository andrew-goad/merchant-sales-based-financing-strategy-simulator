# Business Requirements — M2.3 Final Offer & Decision Authorization

## Business objective

Select and authorize the final governed offer or non-offer outcome while preserving decision rationale and alternatives.

## Governing inputs

- Upstream authority: **M2.2 accepted stage**.
...
- Authorized final offer
- Decision disposition
- Decision rationale and alternative evidence
...
The accepted output feeds **M2.4 accepted stage**. No downstream stage may reinterpret, bypass, or silently replace this stage's accepted contract or lineage.
